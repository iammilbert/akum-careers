            ...
            <div class="row g-0 p-3 card-body">
              ...
              <div class="col-md-5 col-sm-12">
                <div class="bg-white justify-content-between">
                  ...
                  <router-link :to="{ name: 'applicationForm', query: { department: role.dept.name, job_type: role.job_type, faculty: role.faculty.name, jobTitle: role.title, jobId: role._id }}" style="font-size:14px;" class="btn btn-outline-success mb-2" type="button">Apply Now</router-link>
                  </div>
                </div>
              </div>
            </div>
